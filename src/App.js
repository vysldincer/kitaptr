  ...
  return (
    <div className="App  ">
      <div className="container mx-auto h-auto ">
        ...
        <div className="flex bg-gray-100 divide-x  divide-blue-400 text-center  rounded-xl p-8 mt-3">
        ...
        <div className=" bg-blue-100   text-center  rounded-xl p-8 mt-3">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="bg-blue-200 h-10 rounded flex items-center justify-center text-blue-700 text-2xl ">
              Âyet Sayısı : <div className="bg-blue-500 border text-white leading-10 mx-3 px-2 h-full ">1</div>
            </div>

            <div className="bg-blue-200 h-10 rounded flex items-center justify-center text-blue-700 text-2xl ">
              Mekki Âyet Sayısı : <div className="bg-blue-500 border text-white leading-10 mx-3 px-2 h-full ">1</div>
            </div>

            <div className="bg-blue-200 h-10 rounded flex items-center justify-center text-blue-700 text-2xl ">
              Medeni Âyet Sayısı : <div className="bg-blue-500 border text-white leading-10 mx-3 px-2 h-full ">1</div>
            </div>

            <div className="bg-blue-200 h-10 rounded flex items-center justify-center text-blue-700 text-2xl ">
              Toplam Sonuç : <div className="bg-blue-500 border text-white leading-10 mx-3 px-2 h-full ">1</div>
            </div>
